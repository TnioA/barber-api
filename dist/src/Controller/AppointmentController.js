...
exports.default = new class AppointmentController {
    GetAppointments(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            return HttpHelper_1.default.Convert(res, { success: true, data: db_json_1.default.users[0].appointments, error: null });
        });
    }
