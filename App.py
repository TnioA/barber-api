...
def CheckToken():
    ...
    response['data'] = { 'token': 'A15asdf151asdf1819as8d1f9as1d8fa1s81asd8f1as8df1', 'avatar': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAd7SeoDA2PxCcdbtBxBAHYw1xiP_CpXmRFyKSyyiC2Pr_A_vf34p816fwajWCCR9eHBo&usqp=CAU'}
    response['error'] = None
...
def SignUp():
    ...
    response['success'] = True
    response['data'] = { 
        'token': 'A15asdf151asdf1819as8d1f9as1d8fa1s81asd8f1as8df1', 
